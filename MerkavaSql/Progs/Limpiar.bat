...
ren BaseDatos.prg BaseDatos.prg
ren BorraTemp.prg BorraTemp.prg
ren CapaDatos.prg CapaDatos.prg
ren calcular_dv_11_a.prg calcular_dv_11_a.prg
ren Ciudad.prg Ciudad.prg
ren Cliente.prg Cliente.prg
ren Cobrador.prg Cobrador.prg
ren Compra.prg Compra.prg
...
ren hechauka_ventas_v2.prg hechauka_ventas_v2.prg
...
ren Migrator.prg Migrator.prg
ren Modelo.prg Modelo.prg
ren MotivoCliente.prg MotivoCliente.prg
ren NroSerieDisco.prg NroSerieDisco.prg
ren Ot.prg Ot.prg
...
ren TipoDocuComp.prg TipoDocuComp.prg
ren TipoDocuCompSet.prg TipoDocuCompSet.prg
...
ren ValidarRUC.prg ValidarRUC.prg
